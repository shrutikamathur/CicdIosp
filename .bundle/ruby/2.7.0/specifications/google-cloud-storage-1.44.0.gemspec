# -*- encoding: utf-8 -*-
# stub: google-cloud-storage 1.44.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<retriable>.freeze, ["~> 3.1.2"])
  else
    s.add_dependency(%q<google-cloud-core>.freeze, ["~> 1.6"])
    s.add_dependency(%q<google-apis-iamcredentials_v1>.freeze, ["~> 0.1"])
    s.add_dependency(%q<google-apis-storage_v1>.freeze, ["~> 0.19.0"])
    ...
    s.add_dependency(%q<retriable>.freeze, ["~> 3.1.2"])
  end
end
